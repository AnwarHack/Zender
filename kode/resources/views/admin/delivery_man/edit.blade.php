                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <div class="product-add-container border">
                                        ...
                                        <div class="card mb-0">
                                            ...
                                            <div class="card-body">
                                                    ...
                                                    <div class="newdataadd mt-3">
                                                        ...
                                                        @if($deliveryman->kyc_data)
                                                           @foreach ($deliveryman->kyc_data as  $key => $data)

                                                           <div class="row g-3 border-bottom pb-3 mb-3 newuserdata">
                                                            <div class="col-lg-3">
                                                                <input  name="key_name[]" value="{{$key}}" class="form-control" type="text" required placeholder="{{translate('Ex:passport number')}}">

                                                                <input  name="old_key[]" value="{{$key}}" class="form-control" type="hidden" required placeholder="{{translate('Ex:passport number')}}">
                                                            </div>



                                                            <div class="col-lg-3 input-value-section">
                                                                    <input name="value[]"  value="{{$data->value}}" class="form-control input-value" type="text" required placeholder="{{translate('Ex:1234')}}">
                                                            </div>



                                                           <div class="col-lg-3 input-value-section">
                                                                <input accept="image/*" name="file[]" class="form-control input-value" type="file">


                                                                @if($data->file)
                                                                    <div id="kyc-preview">

                                                                        <a target="_blank" href="{{show_image(file_path()['delivery_man_kyc']['path'].'/'.$data->file) }}">
                                                                            <img alt='{{$data->file}}' class="mt-2 rounded  d-block avatar-xl img-thumbnail"
                                                                            src="{{show_image(file_path()['delivery_man_kyc']['path'].'/'.$data->file) }}">
                                                                        </a>
