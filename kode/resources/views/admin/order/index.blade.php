            ...
            <div class="card" id="orderList">
                ...
                <div class="card-body">
                    <ul class="nav nav-tabs nav-tabs-custom nav-primary mb-3" role="tablist">
                        <li class="nav-item">
                            <a class='nav-link {{ request()->routeIs('admin.inhouse.order.index') ? 'active' : '' }} All py-3'
                                id="All" href="{{ route('admin.inhouse.order.index') }}">
                        ...
                        <li class="nav-item">
                            <a class='nav-link {{ request()->routeIs('admin.inhouse.order.pending') ? 'active' : '' }}  Placed py-3'
                                id="pending" href="{{ route('admin.inhouse.order.pending') }}">
                        ...
                        <li class="nav-item">
                            <a class='nav-link {{ request()->routeIs('admin.inhouse.order.placed') ? 'active' : '' }}  Placed py-3'
                                id="Placed" href="{{ route('admin.inhouse.order.placed') }}">
                                <i class="ri-map-pin-line me-1 align-bottom"></i>
                                {{ translate('Placed Orders') }}
                                @if ($physical_product_order_count > 0)
                                    <span
                                        class="badge bg-danger align-middle ms-1">{{ $physical_product_order_count }}</span>
                                @endif
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class='nav-link {{ request()->routeIs('admin.inhouse.order.confirmed') ? 'active' : '' }} Confirmed py-3'
                                id="Confirmed" href="{{ route('admin.inhouse.order.confirmed') }}">
                                <i class="ri-checkbox-multiple-fill me-1 align-bottom"></i>
                                {{ translate('Confirmed Order') }}
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class='nav-link Processing {{ request()->routeIs('admin.inhouse.order.processing') ? 'active' : '' }}   py-3'
                                id="Processing" href="{{ route('admin.inhouse.order.processing') }}">
                                <i class="ri-refresh-line me-1 align-bottom"></i>
                                {{ translate('Processing') }}
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class='nav-link Processing {{ request()->routeIs('admin.inhouse.order.shipped') ? 'active' : '' }}   py-3'
                                id="shipped" href="{{ route('admin.inhouse.order.shipped') }}">
                                <i class="ri-ship-line me-1 align-bottom"></i>
                                {{ translate('Shipped') }}
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class='nav-link py-3 {{ request()->routeIs('admin.inhouse.order.delivered') ? 'active' : '' }}   Delivered'
                                id="Delivered" href="{{ route('admin.inhouse.order.delivered') }}">
                        ...
                        <li class="nav-item">
                            <a class='nav-link {{ request()->routeIs('admin.inhouse.order.cancel') ? 'active' : '' }}   py-3 Ceturns'
                                id="cancel" href="{{ route('admin.inhouse.order.cancel') }}">
                        ...
                        <li class="nav-item">
                            <a class='nav-link {{ request()->routeIs('admin.inhouse.order.return') ? 'active' : '' }}   py-3 Returns'
                                id="Returns" href="{{ route('admin.inhouse.order.return') }}">
                                            ...
                                            <div class="hstack justify-content-center gap-3">
                                                @if (permission_check('view_order'))
                                                    <a title="{{ translate('Print') }}"
                                                        href="{{ route('admin.inhouse.order.print', [$order->id, 'inhouse']) }}"
                                                        class="fs-18 link-success">
                                                        <i class="ri-printer-line"></i>
                                                    </a>
                                                    <a title="{{ translate('Details') }}" data-bs-toggle="tooltip"
                                                        data-bs-placement="top"
                                                        href="{{ route('admin.inhouse.order.details', $order->id) }}"
                                                        class="fs-18 link-info ms-1"><i class="ri-list-check"></i></a>
                                                @endif
                                                @if (permission_check('update_order'))
                                                    <a title="{{ translate('Order Status') }}"
                                                        data-order_id="{{ $order->id }}" data-bs-toggle="tooltip"
