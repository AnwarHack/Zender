...

{
    ...
    public function seller()
    {
        ...
        $sellerDigitalProducts = Product::sellerProduct()->digital()->orderBy('id', 'DESC')->search()->with('category', 'seller', 'subCategory')->paginate(site_settings('pagination_number',10));
    ...
    public function sellerTrashedProduct()
    {
        ...
        $sellerDigitalProducts = Product::with(['seller','category','order'])->sellerProduct()->digital()->onlyTrashed()->search()->orderBy('id', 'DESC')->with('category','subCategory')->paginate(site_settings('pagination_number',10));
        return view('admin.digital_product.seller', compact('title', 'sellerDigitalProducts'));
    }
