...
class SellerProductController extends Controller
{
    ...
    public function index()
    {
        ...
        $products = Product::latest()->sellerProduct()->search()->physical()->with('seller', 'category', 'order')->paginate(site_settings('pagination_number',10));
    ...
    public function new()
    {
        ...
        $products = Product::sellerProduct()->physical()->search()->new()->latest()->with('seller', 'category', 'order')->paginate(site_settings('pagination_number',10));
        return view('admin.seller_product.index', compact('title', 'products'));
    }
    ...
    public function approved()
    {
        ...
        $products = Product::sellerProduct()->physical()->search()->published()->latest()->with('seller', 'category', 'order')->paginate(site_settings('pagination_number',10));
        return view('admin.seller_product.index', compact('title', 'products'));
    }
    ...
    public function refuse()
    {
        ...
        $products = Product::sellerProduct()->physical()->search()->inactive()->latest()->with('seller', 'category', 'order')->paginate(site_settings('pagination_number',10));
        return view('admin.seller_product.index', compact('title', 'products'));
    }
    ...
    public function trashed()
    {
        ...
        $products = Product::with(['seller','category','order'])->sellerProduct()->search()->onlyTrashed()->paginate(site_settings('pagination_number',10));
        return view('admin.seller_product.index', compact('title', 'products'));
    }
